...
const Accesories = () => {
    ...
    const fetchData = async () => {
      ...
      useEffect(() => {
        let filtered = products.filter(product => product.category === 'accesories');
      ...
      const handlePageChange = (newPage) => {
        setPage(newPage);
        navigate(`/accesories/page/${newPage}`);
      };
        ...
        <>
          <Row>
            ...
            <Col md={9}>
              ...
              <PaginateSecond pages={pages} page={page} category="accesories" onPageChange={handlePageChange} />
            </Col>
          </Row>
        </>
      );
